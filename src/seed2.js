export function seedDatabase(firebase) {
  ...
  firebase.firestore().collection("rating").add({
    user: 'Toan',
    film: 'ErG0Zl0BET9fTMiyBzuv',
    filmName: 'Citizenfour',
    comment: 'Phim rat hay',
    rate: '2'
  });
  ...
  firebase.firestore().collection("rating").add({
    user: 'Dung',
    film: 'QfiBdvpGdIzmS4k2PA4G',
    filmName: 'Amanda Knox',
    comment: 'Vui the',
    rate: '1'
  });
